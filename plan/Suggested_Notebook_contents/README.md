...
This repository contains **student** and **instructor** Jupyter notebooks for all 15 lectures.
...
## Lectures
Each lecture folder contains `student/` and `instructor/` notebooks.

- **L01** — `L01_counterfactuals_definition/`
- **L02** — `L02_ideal_rct/`
- **L03** — `L03_observational_assumptions/`
- **L04** — `L04_effect_modification/`
- **L05** — `L05_dags_dseparation/`
- **L06** — `L06_confounding/`
- **L07** — `L07_selection_bias/`
- **L08** — `L08_ipw_propensity/`
- **L09** — `L09_gformula_standardization/`
- **L10** — `L10_causal_survival/`
- **L11** — `L11_msm_time_varying/`
- **L12** — `L12_target_trial_protocol/`
- **L13** — `L13_target_trial_workshop/`
- **L14** — `L14_sensitivity_negative_controls/`
- **L15** — `L15_capstone_presentations/`
