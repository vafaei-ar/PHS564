# PHS564 — Slides Master Plan for NotebookLM (15 sessions)
...
1. Generate **one deck per lecture** (L01–L15), 16:9.
2. Keep ≈ **1:30 per slide (≈80 slides for a full 120-min session; typically 70–85 to allow activities) average**; slides labeled **(Pause/Activity)** are timed anchors.
...
- 02. **Course map (L01–L15)** — Key: Where we are; where we're going — Visual: Draw (vector): timeline of 15 sessions
...
## L12 — Target trial emulation I: protocol, time zero, causal contrast (MIMIC-IV Demo)
**Target slide count:** 70–85 (120 min with pauses/activities)  
**Start with recap:** 3–4 slides summarizing L11 (time-varying confounding; why MSM/IPW is needed).

### Slide blueprint (high-level)
1. **Recap (3–4):** time-varying confounding and why naive adjustment fails.
2. **Why target trials (4–6):** what goes wrong without an explicit protocol (immortal time, selection).
3. **Protocol components (18–22):** eligibility, time zero, strategies, assignment, follow-up, outcome, causal contrast.
4. **Causal estimand & contrast (8–10):** ITT vs per-protocol; RD vs RR; risk vs hazard (brief).
5. **Bias audit workshop (12–15):** teams flag biases in example protocols.
6. **Deliverable preview (6–8):** Protocol v1 + bias audit; what “good” looks like.
7. **Exit poll (2–3).**

### Figures/visuals to include
- “Time zero alignment” timeline (immortal time example)
- Protocol schematic (boxes/arrows: eligibility → strategies → follow-up → outcome)
- Checklist graphic: 10 protocol items (with ticks)

### Notes to NotebookLM
- Keep the protocol section **procedural**: one slide per protocol element with a concrete example line (ICU antibiotics).
- Use speaker notes for the full wording of the protocol element.

---

## L13 — Target trial emulation II: analysis pipeline workshop on Demo extract
**Target slide count:** 55–70 (more time is hands-on)  
**Start with recap:** 2–3 slides summarizing L12 protocol + time zero.

### Slide blueprint (high-level)
1. **Recap (2–3).**
2. **Pipeline overview (4–5):** data → cohort → estimator → diagnostics → results.
3. **Workshop instructions (6–8):** how to run the notebook; what to edit; how to export outputs.
4. **Estimator choices (6–8):** “today we do one primary estimator + one robustness check.”
5. **Diagnostics (8–10):** overlap, weights, balance/model fit; what “bad” looks like.
6. **Mini-presentations (4–6):** “what broke and how we fixed it.”
7. **Exit poll (2–3).**

### Figures/visuals to include
- Pipeline flowchart
- Weights histogram good/bad
- Overlap plot good/bad
- “Results bundle” example screenshot (table + figure + paragraph)

### Notes to NotebookLM
- Slides should *support* the workshop; avoid long derivations.
- Include explicit “STOP and run cell X” prompts.

---

## L14 — Robustness & sensitivity: unmeasured confounding, negative controls, pragmatic checks
**Target slide count:** 70–85  
**Start with recap:** 2–3 slides summarizing L13 pipeline + diagnostics.

### Slide blueprint (high-level)
1. **Recap (2–3).**
2. **Why robustness matters (4–6):** “one estimate is not enough.”
3. **Unmeasured confounding sensitivity (20–25):**
   - E-value (concept + compute)
   - simple bias-factor/tipping point
4. **Negative controls (12–16):** exposure vs outcome; what they can/can’t tell you.
5. **Pragmatic robustness checklist (10–12):** alternate specs, missingness table, overlap report.
6. **Optional IV mini-appendix (≤10 slides):** strong vs weak IV; why not core in EHR.
7. **Exit poll (2–3).**

### Figures/visuals to include
- E-value schematic (strength of confounding needed)
- Tipping-point heatmap (bias-factor grid)
- Negative control DAG cartoons (simple)
- “Robustness checklist” infographic

### Notes to NotebookLM
- Keep sensitivity content **interpretive**: “what would change your conclusion?”
- Avoid deep algebra; show minimal formulas with clear annotations.

---

## L15 — Capstone: presentations + synthesis + course wrap-up
**Target slide count:** 25–40 (presentations dominate)  
**Start with recap:** 1–2 slides summarizing L14 (robustness mindset).

### Slide blueprint (high-level)
1. **Recap (1–2).**
2. **Presentation rubric (3–4):** what to show (estimand, cohort, method, diagnostics, results, limitations).
3. **Timing slide (1):** per-team timing and Q&A rules.
4. **Synthesis (8–12):** common pitfalls seen across projects; best practices.
5. **Course wrap-up (4–6):** how to continue learning; recommended tools/papers.
6. **Exit poll (course feedback) (2–3).**

### Figures/visuals to include
- One slide “good presentation structure” template
- Checklist: “what must be on your results slide”
- Simple montage placeholder for team outputs (optional)

### Notes to NotebookLM
- Keep slides minimal; most time is student presentations.
